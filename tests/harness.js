...
function load(w, h) {
  ...
  vm.runInContext(fs.readFileSync(__dirname + '/../game.js', 'utf8') + '\n;__out({Game,Camera,Input,UI,Actor,genCharacter,genPlayer,genCartMan,ARCHETYPES,POSTURES,inkW,dayPalette,buildCity,Crowd,TOWER,GROUND,SCENES,ElevatorScene,PLAYER_FLOOR,DESTS,AirportScene,LANDMARKS,City,BLOCK,Sfx,Music,Tex});', ctx);
